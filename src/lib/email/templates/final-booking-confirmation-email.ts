export interface FinalBookingConfirmationEmailData {
  studentName: string
  tutorName: string
  subject: string
  level: string
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
    <h2 style="color: #333; margin-top: 0;">✅ Rezerwacja potwierdzona</h2>
    
    <p>Dzień dobry ${studentName.split(' ')[0]},</p>
    
    <p>Mamy przyjemność poinformować, że Twoja rezerwacja została <strong>potwierdzona</strong> przez administratora. Oto szczegóły zarezerwowanej lekcji:</p>
    ...
    <div style="background: #d4edda; border-left: 4px solid #28a745; padding: 15px; margin: 20px 0;">
      <strong>✅ Status:</strong> <span style="color: #155724;">Potwierdzona i zaakceptowana</span>
      <p style="margin: 10px 0 0 0; font-size: 14px;">
        Twoja rezerwacja została oficjalnie potwierdzona. Lekcja jest zarezerwowana i odbędzie się w podanym terminie.
      </p>
    </div>
